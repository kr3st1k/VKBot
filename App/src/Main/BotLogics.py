...
class VKApi:
    ...
    def vk_method(self, method_name: str, parameters: list, validation_num=51181):
        ...
        try:
            ...
            if validation['response'] == validation_num:
                return 0
            else:
    ...
    def send_method(self, type_id: str, id: str, message: str = None, attachment: str = None, keyboard=None):
